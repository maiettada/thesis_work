...
Nel caso del Machine Learning un task di NER può avere risultati migliori delle regex, 
...
si potrebbe ricorrere al modello regex per le entità meno assimilate dal modello ML, preferendo invece quest'ultimo
