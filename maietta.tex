...
\newacronym{societa-soa}{SOA}{Società Organismi di Attestazione}
\input{soa-acronyms.tex}
...
%******FUNZIONALITÀ STANDARD DI TOPTESI UTILIZZABILI DOPO BEGIN DOCUMENT*********************************************

%%% scegliere la propria facoltà (solo PRIMA dell'AA 2012-2013) \facolta[III]{Ingegneria dell'Informazione} \facolta[IV]{Organizzazione d'Impresa\\e Ingegneria Gestionale}
...
% e dell'Ing. (tutore aziendale)% inserire solo se la monografia è relativa ad un tirocinio.
...
\titolo{Estrazione di entità da testi della Pubblica Amministrazione}% per la laurea quinquennale e il dottorato
\corsodilaurea{Ingegneria Informatica}% per la laurea di primo e secondo livello
\candidato{Davide \textsc{Maietta}}% per tutti i percorsi
\relatore{prof.\ Maurizio Morisio}% per la laurea e il dottorato
\sedutadilaurea{\textsc{Novembre} 2017}% per la laurea triennale
...
\input{capitoli/chapter1.tex}

\input{capitoli/chapter2.tex}

\input{capitoli/chapter3.tex}


\input{capitoli/chapter4.tex}
\input{capitoli/machinelearning.tex}


\input{capitoli/chapter5.tex}
...
%\input{biblio.tex}
% se la bibliografia è stata scritta (usando Bibtex) nel file biblio.bib allora commentare la riga precedente e scommentare le due righe seguent
